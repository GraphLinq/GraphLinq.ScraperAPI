...
eval cd /Users/john/Desktop/GraphLinq.ScraperAPI/data/default-token-list && git pull && npm run build && mv /Users/john/Desktop/GraphLinq.ScraperAPI/build/uniswap-default.tokenlist.json /Users/john/Desktop/GraphLinq.ScraperAPI/data/uniswap-default.tokenlist.json
echo "Update Uniswap JSON Data... Done"
echo "Update QuickSwap JSON Data..."
eval cd /Users/john/Desktop/GraphLinq.ScraperAPI/data/quickswap-default-token-list && git pull && npm run build && mv /Users/john/Desktop/GraphLinq.ScraperAPI/build/quickswap-default.tokenlist.json /Users/john/Desktop/GraphLinq.ScraperAPI/data/quickswap-default-token-list.json
echo "Update QuickSwap JSON Data... Done"
echo "Delete Old curled JSON Data..."
eval cd /Users/john/Desktop/GraphLinq.ScraperAPI/data && rm -rf *.json
